			...
			if ( $this->has_image_overlay() ) {
				...
				<div <?php echo $this->get_render_attribute_string( 'image-overlay' ); ?>>
					...
					<?php if ( 'yes' === $settings['show_play_icon'] ) : ?>
						...
						<img class="image-playbutton"src="<?php echo get_stylesheet_directory_uri();?>/qazana/widgets/image/Playbutton.svg" alt="Play Button"/><span class="qazana-screen-only"><?php _e( 'Play Video', 'qazana' ); ?></span>
						</div>
					<?php endif; ?>
				</div>
			<?php } ?>
